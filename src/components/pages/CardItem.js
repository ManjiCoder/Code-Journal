...
function CardItem({ title, APIKEY, alertTodo, query }) {
  ...
  const getRow = async () => {
    ...
    console.log(`${url}?query=${query}`, data);
    return data;
  };
          ...
          {data && data.map((element, index) => {
            return (
              ...
              >
                ...
                <p className="mb-3 font-normal text-gray-600 dark:text-gray-400">
                  Language - <span className={`font-bold`}>{element.Lang}</span>
                </p>
                <p className="mb-3 font-normal text-gray-600 dark:text-gray-400">
                  Accuracy -{" "}
                ...
                <p className="mb-3 font-normal text-gray-600 dark:text-gray-400">
                  Date - <span className={`font-bold`}>{new Date(element.Date).toDateString()}</span>
                </p>
                <p className="mb-3 font-normal text-gray-600 dark:text-gray-400">
                  Score -{" "}
                ...
                <section className="flex justify-between py-7">
                  <Link to="/update" state={data[totalResult.current-index-1]}>
                    <i
                      ...
                      // onClick={()=>{
                      //   console.log(data[totalResult.current-index-1])
                      // }}
                    ></i>
                    <Tooltip text="Edit" />
                  </Link>
